...
def get_brightness_in_Rayleighs(M,theta,dlambda,sol_angle,num_of_pixels,flux):
...
# print(get_brightness_in_Rayleighs(M_keo,36*np.pi/180,20,sol_angle_keo,6,236.5*10**-3))
...
# get_brightness_in_Rayleighs(M_s1c,5*np.pi/180,100,sol_angle_s1c,12,236.5*10**-3)
