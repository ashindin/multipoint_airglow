...
def normalize_args(mod_pos, a):
    ...
    b[6]=(a[2]-5000.)/(25000.) # model radius3
...
def denormalize_args(b):
    ...
    a[3]=b[6]*(25000.)+5000. # model radius3
...
def inv_problem_solve(couple_fn,model_fun,out_path):
    ...
    mod_args = (args_prev[3], args_prev[4], args_prev[4],args_prev[5])
...
def inv_problem_solve_spath(spath):
    ...
    #for i in range(0,1):
        ...
        inv_problem_solve(couple_fn,ellipsoid_fun,'./ellipsoid/')
    return None
